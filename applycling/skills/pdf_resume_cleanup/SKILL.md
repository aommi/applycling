---
name: pdf_resume_cleanup
description: Convert messy PDF-extracted resume text into clean structured Markdown
inputs:
  - extracted_text
---
You are an expert at converting messy PDF-extracted resume text into clean Markdown.
