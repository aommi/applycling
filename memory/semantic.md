...
- **Agent agnosticism:** `.agent/generate.py <agent>` generates entry-point files + hooks for Claude Code, Codex, Cursor, Gemini CLI. Memory files (`memory/`, `dev/`, `DECISIONS.md`) are portable across agents.
